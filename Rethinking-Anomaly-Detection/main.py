...
# python main.py --dataset amazon-new --train_ratio 0.4 --hid_dim 64 --order 2 --homo 1 --epoch 200 --run 1
...
def train(model, g, args):
    ...
    if dataset_name == 'amazon' or dataset_name == 'amazon':
    ...
    for e in range(args.epoch):
        ...
        # print(set(labels[test_mask].tolist()) - set(preds[test_mask].tolist()))
